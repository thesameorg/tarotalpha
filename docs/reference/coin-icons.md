...
- Для монеты без иконки в пакете `web/public/coins/<тикер>.svg` — круг с первой буквой тикера в стиле пакета (32×32, цвет круга выведен из тикера). Тикер не из списка идёт без иконки: запасного круга нет.
