...
export const ja: Dictionary = {
  ...
  paid: {
    ...
    invite: (mana: number): string => `入門者を招く · 双方に +${String(mana)}`,
    welcomed: (mana: number): string => `招かれました：マナ +${String(mana)}`,
  },
  paywall: {
    ...
    address: "ウォレット",
    comment: "コメント",
    commentWarn: "コメントがないと支払いを見つけられません。ウォレットではこの欄を comment、memo、note と呼びます。",
    openWallet: "ウォレットを開く",
    waiting: "支払いを待っています",
    credited: (mana: number): string => `財布の中: ${String(mana)}`,
    endless: "あなたの財布はもう尽きません",
    ...
    endlessLot: "尽きない財布",
    paid: "入金されました",
    lead: "リーディングは一日ごとにマナを使い、先の日ほど高くつきます。未来ほど見えにくいからです。マナは1時間ごとに少しずつ戻り、新しい日には満タンになります。",
    buy: "購入",
    back: "リーディングに戻る",
  },
  fan: { hint: "3枚引いてください", close: "閉じる" },
  cloth: "タロットを開いて、ローソク足の運命を知ろう",
  reader: {
    unscored: "まだ評価なし",
