...
export const fr: Dictionary = {
  ...
  paid: {
    ...
    invite: (mana: number): string => `Inviter un initié · +${String(mana)}`,
  },
  paywall: {
    ...
    credited: (mana: number): string => `Crédité. Mana achetée : ${String(mana)}`,
    endless: "Crédité. Votre bourse ne s'épuise plus",
