...
export const zh: Dictionary = {
  ...
  paid: {
    ...
    invite: (mana: number): string => `邀请一位入门者 · +${String(mana)}`,
  },
  paywall: {
    slow: "已支付，魔力马上到账",
    scan: "用钱包的相机扫一扫",
    ...
    address: "钱包",
    comment: "备注",
    commentWarn: "没有备注就找不到这笔付款。钱包里这个字段叫 comment、memo 或 note。",
    openWallet: "打开钱包",
    waiting: "等待付款",
    ...
    meditating: "支付模块仍在冥想",
    title: "法力耗尽了",
    lead: "牌阵的每一天都要消耗法力，越远的日子越贵：未来越难看清。法力每小时恢复一些，新的一天到来时完全回满。",
    buy: "购买",
    back: "返回牌阵",
  },
  fan: { hint: "抽三张牌", close: "关闭" },
  cloth: "摆一次塔罗牌阵，看看蜡烛的命运",
  reader: {
    unscored: "尚无评分",
