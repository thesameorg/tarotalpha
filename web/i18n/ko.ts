...
export const ko: Dictionary = {
  ...
  paid: {
    ...
    invite: (mana: number): string => `입문자를 초대 · 양쪽 각각 +${String(mana)}`,
    welcomed: (mana: number): string => `초대받았습니다: 마나 +${String(mana)}`,
  },
  paywall: {
    ...
    address: "지갑",
    comment: "메모",
    commentWarn: "메모가 없으면 결제를 찾을 수 없습니다. 지갑에서는 이 항목을 comment, memo, note라고 부릅니다.",
    openWallet: "지갑 열기",
    waiting: "결제를 기다리는 중",
    credited: (mana: number): string => `지갑에: ${String(mana)}`,
    endless: "이제 지갑이 바닥나지 않습니다",
    failed: "실패했습니다. 다시 시도해 주세요",
    meditating: "결제 모듈은 아직 명상 중입니다",
    titleShort: "마나가 부족합니다",
    titleTopUp: "마나 구매",
    house: "하우스 추천",
    endlessLot: "바닥나지 않는 지갑",
    paid: "충전됨",
    lead: "리딩의 하루하루에는 마나가 들고, 먼 날일수록 더 비쌉니다. 먼 미래일수록 보기 어렵기 때문입니다. 마나는 매시간 조금씩 돌아오고, 새로운 날이 되면 가득 찹니다.",
    buy: "구매",
    back: "리딩으로 돌아가기",
  },
