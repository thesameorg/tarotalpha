...
export const tr: Dictionary = {
  ...
  paywall: {
    ...
    credited: (mana: number): string => `Kesede: ${String(mana)}`,
    endless: "Keseniz artık bitmiyor",
    failed: "Olmadı. Tekrar deneyin",
    meditating: "Ödeme modülü hâlâ meditasyonda",
    titleShort: "Mana yetmiyor",
    titleTopUp: "Mana satın al",
    house: "kasanın seçimi",
    endlessLot: "Hiç bitmeyen bir kese",
    paid: "Yüklendi",
